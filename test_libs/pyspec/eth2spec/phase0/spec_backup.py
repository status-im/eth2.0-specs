...
def get_compact_committees_root(state: BeaconState, epoch: Epoch) -> Hash:
    ...
    res = hash_tree_root(Vector[CompactCommittee, SHARD_COUNT](committees))
...
def process_final_updates(state: BeaconState) -> None:
    ...
    print(f'index root {index_root_position} {state.active_index_roots[index_root_position]}')
    enable_printing(False)
    ...
    print(f'com root {committee_root_position} {state.compact_committees_roots[committee_root_position]}')
